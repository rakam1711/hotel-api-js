...
resturantRouter.post('/menu/:itemid/delete',async (req, res, next) => {await protect(req, res, next)},
  async (req, res) => {
...
resturantRouter.post('/menu/:itemid/update',async (req, res, next) => {await protect(req, res, next)},
async (req, res) => {
